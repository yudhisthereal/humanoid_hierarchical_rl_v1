"""Simple render script for Op3ArmBraceEnv.

Usage:
    python render.py --checkpoint checkpoints/arm_brace_v1/best_op3_arm_brace_model.pth --video_name demo.mp4
"""
...
def main():
    parser = argparse.ArgumentParser(description="Render Op3ArmBraceEnv with a trained checkpoint (three POVs).")
